	...
	while True:
		...
		if (mode == 0):
			if (needtostart == 1):
				...
				Popen(['omxplayer', '--no-keys', '-b', '--loop', '--no-osd', startmovie], stdout=None, stderr=None)
				running = 1
				hasrun = 0
		...
		###################################################################
			...
			if (needtostart == 1):
				...
				needtostart = 0
				Popen(['omxplayer', '--no-keys', '-b', '--no-osd', movie1], stdout=None, stderr=None)
				running = 1
				hasrun = 0
				killoldplayers(players)
			else:
		...
		###################################################################
			...
			if (needtostart == 1):
				...
				needtostart = 0
				Popen(['omxplayer', '--no-keys', '-b', '--no-osd', movie2], stdout=None, stderr=None)
				running = 1
				hasrun = 0
				killoldplayers(players)
			else:
				...
				if (needtostart == 1):
					mode = 0
		#give the loop some breathing space (stops hangs?)
		time.sleep(0.1)
